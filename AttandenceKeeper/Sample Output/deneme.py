...
# I learn from internet it helps to detect names and surnames who have two names people
    ...
    def export_to_file(self):
        ...
        if file_type == ".csv":  # if the selected file type is CSV
            ...
            for index in range(self.right_listbox.size()):
                ...
                surname, name, student_id = student_info.split(',')  # This line split from (,) students
                department = Student.get_department
                # info because I need them all separately
                sheet.append([student_id, f"{surname} {name}", department])
